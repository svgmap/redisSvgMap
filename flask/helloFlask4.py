...
generalHkey = (
    True
)  # 個々のデータを投入するhmapのkey(これはgeoHashではなく、その下の個々のデータを入れる入れ物のハッシュキー(なのでどうでもいいといえばどうでもいい))をどうするか
...
poiColor = [
    ...
    {"flag": "8", "color": "#ff0000"},
    {"flag": "9", "color": "#ff0000"},
    {"flag": "10", "color": "#ff0000"},
    {"flag": "11", "color": "#ff0000"},
    {"flag": "12", "color": "#ff0000"},
    {"flag": "13", "color": "#ff0000"},
    {"flag": "14", "color": "#ff0000"},
    {"flag": "15", "color": "#ff0000"},
    {"flag": "16", "color": "#ff0000"},
    {"flag": "17", "color": "#ff0000"},
    {"flag": "18", "color": "#ff0000"},
    {"flag": "19", "color": "#ff0000"},
    {"flag": "20", "color": "#ff0000"},
    {"flag": "21", "color": "#ff0000"},
    {"flag": "22", "color": "#ff0000"},
    {"flag": "23", "color": "#ff0000"},
    {"flag": "24", "color": "#ff0000"},
    {"flag": "25", "color": "#ff0000"},
    {"flag": "26", "color": "#ff0000"},
    {"flag": "27", "color": "#ff0000"},
    {"flag": "28", "color": "#ff0000"},
    {"flag": "29", "color": "#ff0000"},
    {"flag": "30", "color": "#ff0000"},
    {"flag": "31", "color": "#ff0000"},
    {"flag": "32", "color": "#ff0000"},
    {"flag": "33", "color": "#ff0000"},
    {"flag": "34", "color": "#ff0000"},
    {"flag": "35", "color": "#ff0000"},
    {"flag": "36", "color": "#ff0000"},
    {"flag": "37", "color": "#ff0000"},
    {"flag": "38", "color": "#ff0000"},
    {"flag": "39", "color": "#ff0000"},
    {"flag": "40", "color": "#ff0000"},
    {"flag": "41", "color": "#ff0000"},
    {"flag": "42", "color": "#ff0000"},
    {"flag": "43", "color": "#ff0000"},
    {"flag": "44", "color": "#ff0000"},
    {"flag": "45", "color": "#ff0000"},
    {"flag": "46", "color": "#ff0000"},
    {"flag": "47", "color": "#ff0000"},
]  # poiColor = f1:#FF0000,f2:#ff0000,f3:#0000FF -> split(",") -> split(":")
colorColumn = 3
# --------------------------------------------------------------
...
def getEditStat(dsHash=dbnsDefault):
    ...
    if isinstance(redisRegistJob, redisRegistThread) and redisRegistJob.isAlive():
        ...
        if regStat == "S3_":
            regStat = (
                "S3_"
                + str(csv2redis.getBuildAllLowResMapCount())
                + "/"
                + str(allLowResMapLen)
            )
            pass
...
def getData(poiDatas, latCol, lngCol):
    ...
    for poiData in poiDatas:
        ...
        if generalHkey is True:
            hkey = (
                str(math.floor(lat * 100000))
                + ":"
                + str(math.floor(lng * 100000))
                + ":"
                + meta
            )
            ...
            if reg.search(meta):
                ...
                hkey = (
                    str(math.floor(lat * 100000)) + ":" + str(math.floor(lng * 100000))
                )
...
def getMalTile(tileName="index.html", dsHash=dbnsDefault):
    ...
    if tileName.startswith("svgMapTile") and (
        tileName.endswith(".svg") or tileName.endswith(".png")
    ):
        geoHash = None
        spos = 10
        epos = tileName.find(".")
        ...
        csv2redis.poi_init(poiSize, poiColor, colorColumn)
        ...
        if tileName.endswith(".svg"):
            ...
            pngByteIo = csv2redis.saveSvgMapTileN(
                geoHash, None, LowResImage, True, True
            )
            return send_file(pngByteIo, mimetype="image/png")
    elif tileName.startswith("svgMap") and tileName.endswith(
        ".svg"
    ):  # for root svg content
        csv2redis.init(dsHash)
